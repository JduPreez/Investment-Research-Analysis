...
capital_expenditures_row    <- "Capital Expenditure, Reported"
...
# TODO: Get years from column names, because order differs from company to company
colnames(analysis)  <- c("2015", "2016", "2017", "2018", "2019")
