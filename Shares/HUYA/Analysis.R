...
company               <- "HUYA"
row_name_column       <- "HUYA_IncomeStatement_Annual_As_Originally_Reported"
required_ret_int_rate <- 10
current_share_price   <- 153.08 # CNY
...
debt_row                    <- c("Current Debt and Capital Lease Obligation", 
...
balance_sheet_src       <- read_excel(here("Data", "Companies", company, "Balance-Sheet-Annual.xls"))
